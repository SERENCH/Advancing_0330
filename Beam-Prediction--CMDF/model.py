...
class ECA_layer(nn.Module):
    def __init__(self, channels, gamma=2, bias=1):
        ...
        self.gamma = gamma
        self.bias = bias
        t = int(abs((math.log(channels, 2) + self.bias) / self.gamma))
...
class Encoder(nn.Module):
    ...
    def __init__(self, config, device):
        ...
        self.image_eca = ECA_layer(512)
        self.radar_eca = ECA_layer(512)
    ...
    def forward(self, image_list, radar_list):
        ...
        image_features = self.image_eca(image_features)
        radar_features = self.radar_eca(radar_features)
